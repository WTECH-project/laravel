...
<section class="grid grid-cols-1 sm:grid-cols-2 place-items-center">
    ...
    ?>
    <a class="w-5/6 h-5/6 max-h-96 shadow-lg relative sm:ml-7 lg:ml-14 xl:ml-20 mt-14 sm:mt-0" href="{{ route('products', $female_category_id )}}">
    ...
    <a class="w-5/6 h-5/6 max-h-96 shadow-lg relative sm:mr-7 lg:mr-14 xl:mr-20" href="{{ route('products', $male_category_id )}}">
